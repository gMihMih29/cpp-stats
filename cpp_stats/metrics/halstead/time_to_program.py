'''
Module for MEAN_HALSTEAD_TIME_REQUIRED_TO_PROGRAM, SUM_HALSTEAD_TIME_REQUIRED_TO_PROGRAM
and MAX_HALSTEAD_TIME_REQUIRED_TO_PROGRAM metrics.
'''
...
SUM_HALSTEAD_TIME_REQUIRED_TO_PROGRAM = 'SUM_HALSTEAD_TIME_REQUIRED_TO_PROGRAM'
...
class SumHalsteadTimeToProgramMetric(SumHalsteadMetric):
    '''
    Represents SUM_HALSTEAD_TIME_REQUIRED_TO_PROGRAM metric.
    '''
    ...
    def __init__(self, data: dict[str, HalsteadData]):
        super().__init__(
            ...
            SumHalsteadTimeToProgramMetric,
            data
        )

# pylint: disable=R0903
class SumHalsteadTimeToProgramCalculator(HalsteadCalculator):
    '''
    Calculates SUM_HALSTEAD_TIME_REQUIRED_TO_PROGRAM.
    '''
